...
export const refreshHandler = catchErrors(async (req: Request, res: Response) => {
  ...
  return setAuthCookies({ res, accessToken, refreshToken: newRefreshToken }).status(OK).json({
...
export const sendPasswordResetHandler = catchErrors(async (req: Request, res: Response) => {
