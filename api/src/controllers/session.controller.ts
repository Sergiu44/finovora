...
export const getSessionsHandler = catchErrors(async (req: Request, res: Response) => {
...
export const deleteSessionHandler = catchErrors(async (req: Request, res: Response) => {
