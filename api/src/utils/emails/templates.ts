...
const verifyEmailSchema = z.object({
  code: z.string().min(6).max(6).regex(/^\d+$/, "Code must contain only digits")
});
...
export const createVerifyEmailTemplate = (code: string) =>
  emailTemplateFactory("verifyEmail", { code });

export const createPasswordResetTemplate = (url: string) =>
  emailTemplateFactory("passwordReset", { url });

// Export main factory function and types
export { emailTemplateFactory };
export type { EmailTemplate, TemplateType };