...
import type { DefaultGradientItem } from "../nomenclatures/defaultGradient";
import type { TransactionAccountCardFormat } from "../transactions";
import type { UserGradientItem } from "../users/userGradients";
import type { AccountType } from "./userAccountTypes";
...
export interface AccountCardFormat extends Account {
  defaultGradient: DefaultGradientItem;
  userGradient: UserGradientItem;
